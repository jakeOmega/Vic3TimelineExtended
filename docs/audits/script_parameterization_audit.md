...
| [common/scripted_effects/te_construction_market_build_effects.txt](../common/scripted_effects/te_construction_market_build_effects.txt) | `te_construction_market_set_specified_level`, `te_construction_market_add_specified_level`, `te_construction_market_build_specified_level` | `$SPEC_TYPE$`, `$SPEC_LEVEL$`, `$ADD_LEVEL$` | Set / add building levels without level creep |
