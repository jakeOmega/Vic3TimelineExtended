...
| `events/te_debug_monetary_events.txt` | console-only `te_debug_monetary.1`–`.4` — the single place hidden state is printed, deliberately unreachable from script |
