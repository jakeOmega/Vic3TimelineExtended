...
- **Balance** (spec § Slice 5): net of the burn drain at 10 % per-op detection, a moderate operation earns about +0.4 a month, a severe one +0.1, a mild one +0.7. Gains diminish and losses do not, so the score settles where N × (100 − x)/50 = p × L: one moderate op at 10 % near 70, two near 85. Months to 25 / 50 / 60 with moderate ops at 10 %: 1 op 63 / 125 / ~165; 2 ops 31 / 63 / ~85; 4 ops 16 / 31 / ~45.
