...
- **Restoration and notices.** Representation is restored the moment the member conducts its own foreign policy again. `un_representation_monthly_update` posts one notice either way and strips a suspended member's permanent seat.
