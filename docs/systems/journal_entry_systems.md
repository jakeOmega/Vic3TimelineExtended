...
> **Redesign in progress:** see [`un_redesign_design.md`](un_redesign_design.md). Phase 1 (the authority model) and phase 2 (tiers, the charter, the crisis, dissolution and refounding) have shipped and are described under *Authority* and *The ladder, the ceiling and the floor* below. Grounds and transparent voting, the docket, and missions are still to come. Everything else in this section is the system as it stands.
