...
| [`systems/nuclear_crisis_design.md`](systems/nuclear_crisis_design.md) | **Phases 1–3 implemented, 4–5 in part; pending in-game verification.** Nuclear doctrine, readiness, launch authority, crisis bargaining, guarantees, domestic incentives, accident chains, and alternate-history AI; §0 holds what shipped (`je_nuclear_deterrence`), the deviations and the in-game checklist | Before touching `je_nuclear_deterrence`, the nuclear strike actions' gates, or any `nd_*` script |
