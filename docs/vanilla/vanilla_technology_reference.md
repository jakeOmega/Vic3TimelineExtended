...
> **Last verified against vanilla:** 1.14.2 (open beta). Wiki source for this article is dated 1.10; tree contents change every major patch (1.11–1.13 added several Era-V techs and reshuffled some prerequisites). **Verify specific technology IDs against the live game** via `/raw/Technology/<id>` or `docs/engine/technologies.txt` before quoting prerequisites in code.
>
