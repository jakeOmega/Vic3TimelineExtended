...
> **Last verified against vanilla:** 1.14.2 (open beta). Wiki source dates this article 1.10–1.12; native-uprising mechanics, Colonial Administration JE, and company-colonization rights are all 1.10+ content. Verify specific conditions / cooldowns against `common/journal_entries/`, `common/decisions/`, `common/diplomatic_actions/`, and the relevant law file.
>
