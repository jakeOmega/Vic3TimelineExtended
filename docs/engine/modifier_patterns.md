<!-- Auto-generated from modifiers.log + common/_meta/modifier_patterns.yml (modifiers.log @ 2026-05-20T22:04:03+00:00). Do not hand-edit. Run POST /reload after the engine regenerates the source. -->
...
- Members in engine docs: **0**
- Vocab size: 1019; missing entries: 1019
...
- Vocab size: 1019; missing entries: 719
