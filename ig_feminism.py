...
def modify_interest_group_files(input_dir, output_dir, modification_dict):
    ...
    for filename in os.listdir(input_dir):
        ...
        if filename in modification_dict:
            ...
            # `utf-8-sig` writes the leading BOM so the engine doesn't emit a
            # "should be in utf8-bom encoding" warning for every regenerated file.
            with open(
                os.path.join(output_dir, filename), "w", encoding="utf-8-sig"
            ) as file:
                file.write("# AUTO-GENERATED by ig_feminism.py - Do not edit manually\n\n" + content)
