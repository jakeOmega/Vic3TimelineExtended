...
with open(mod_path + r"\common\cultures\assimilation_cultures.txt", "w", encoding="utf-8-sig") as file:
    file.write("# AUTO-GENERATED by assimilation_cultures.py - Do not edit manually\n\n" + output)
...
with open(mod_path + r"\common\on_actions\assimilation_on_action.txt", "w", encoding="utf-8-sig") as file:
    file.write(
        "# AUTO-GENERATED by assimilation_cultures.py - Do not edit manually\n\n"
